										...
										<div class="dropdown profile-dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
												<div class="text-center">
													<a href="#" class="dropdown-item text-center user pb-0 font-weight-bold"><?php echo $_COOKIE['user'];?></a>
													<span class="text-center user-semi-title"><?php echo $_COOKIE['tipe'];?></span>
												...
												-->
												<a class="dropdown-item d-flex" href="delete_cookies.php">
